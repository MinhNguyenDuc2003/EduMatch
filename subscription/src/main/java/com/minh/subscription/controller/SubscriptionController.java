...
public class SubscriptionController {
    ...
    @GetMapping("/all")
    public ApiResponse<List<SubscriptionVo>> getAll() {
        return ApiResponse.ok(subscriptionService.getAll());
    }

    @GetMapping("/{id}")
    public ApiResponse<SubscriptionVo> getById(@PathVariable Long id) {
    ...
    public ApiResponse<List<SubscriptionVo>> getAllSubscriptionsByUserId(@PathVariable String userId) {
