...
public final class CoreMessageCode {

    public static final String SERVICE_ACCESS_DENIED = "Service access denied";
    public static final String SERVICE_UNAUTHORIZED = "Service unauthorized";
    public static final String IDENTITY_AUTHENTICATED_FAIL = "Identity authenticated fail";
    ...
    public static final String USERNAME_ALREADY_EXITED = "Username already exited";
