...
const ApplicationsForm = ({
  ...
  const t = useTranslations('homepage.activity.applicationForm');
        ...
        <form onSubmit={methods.handleSubmit(handleFormSubmit)}>
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <h2 className="text-lg font-semibold text-gray-900">{t('sections.personalInformation')}</h2>
            ...
            <div className="space-y-6">
              <h2 className="text-lg font-semibold text-gray-900">{t('sections.educationalBackground')}</h2>
            ...
            {/* Skills & Achievements */}
            <div className="space-y-6">
              <h2 className="text-lg font-semibold text-gray-900">{t('sections.skillsAchievements')}</h2>
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <h2 className="text-lg font-semibold text-gray-900">{t('sections.additionalInformation')}</h2>
                <Button
                  type="button"
              ...
              {(!watch('applicationAttributes') ||
                ...
                <p className="text-sm text-gray-500 italic">{t('additionalInfo.noAttributesAdded')}</p>
              )}
            </div>
