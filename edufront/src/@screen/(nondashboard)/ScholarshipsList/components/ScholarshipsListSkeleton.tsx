      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-blue-50/30 pt-20 pb-4 px-4 md:py-8 md:px-10 lg:px-40 lg:pt-8">
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            {/* Left Sidebar - Filters Skeleton (Desktop only, 1 columns) */}
            ...
            {/* Middle Content - Scholarship Cards (2 columns desktop, full width mobile) */}
            ...
            <div className="lg:col-span-1">
              <div className="bg-gradient-to-r from-[#1B3053] to-[#3D6CB9] rounded-t-lg px-3 py-2">
                <div className="flex items-center gap-2">
                  <Skeleton className="h-6 w-16" />
                </div>
              </div>

              <div className="bg-white rounded-b-lg px-3 py-2">
                <div className="flex items-center gap-2">
                  <Skeleton className="h-6 w-16" />
                </div>
              </div>
