  ...
  const Content = () => (
    <div className="space-y-6">
      <div className="flex items-center gap-5">
        <div className="">
          <h3 className="text-lg font-semibold text-gray-900">Description of your phone numbers</h3>
          <p className="text-sm text-gray-600 ">
            Describe the phone numbers you want (you can add more phone numbers if you want)
          </p>
        </div>
        <Button
          type="button"
  ...
  return (
    <Dialog open={open} onOpenChange={handleCancel}>
      <DialogContent className="lg:min-w-6xl md:min-w-4xl min-w-2xl max-h-[90vh] flex flex-col gap-2.5 overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-xl font-bold text-primary-brand">Phone Numbers</DialogTitle>
