...
function ReportFeedbackDetailInner({ meds, id }: { meds: any; id: string }) {
  ...
  //     alert('Failed to update ReportFeedback.');
  //   } finally {
  //     setLoading(false);
  //   }
  // };
  ...
  if (!data)
    return (
      <div className="p-16 text-center text-gray-500 animate-pulse">
        Loading ReportFeedback details...
      </div>
    );

  const banner = data.ReportFeedbackMedias?.[0]?.url;
  ...
  return (
    <div className="max-w-6xl mx-auto bg-white p-10 mt-10 rounded-2xl shadow-lg border border-gray-100 space-y-10">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        />
        <CustomFormField
          label="ReportFeedback Type"
          initialValue={form.ReportFeedbackType}
          // disabled={!isEditing}
          isBorder
        />
        <CustomFormField
