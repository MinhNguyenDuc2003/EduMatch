...
export default function ApplicationScholarship() {
  ...
  const totalapplicationScholarships = users.length;
  const activeapplicationScholarships = users.filter((u) => u.status === 'Đang hoạt động').length;
  ...
  const stats = [
    {
      ...
      value: totalapplicationScholarships,
      icon: <User />,
      color: 'text-blue-600',
      filterName: '',
    },
    {
      ...
      value: activeapplicationScholarships,
      icon: <ShieldCheck />,
